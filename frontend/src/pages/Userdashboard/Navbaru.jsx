...
return (
 ...
 <div className={`${sidebarToggle ? "hidden" : "block"} flex-row  w-64 bg-neutral-200 fixed h-full py-2`}>
      ...
      <ul className="mt-3  bg-gray-300 text-black opacity-100 font-bold">
        ...
        <li className="mb-2 rounded hover:shadow py-2">
          <a href="" style={{ textDecoration: 'none' }} ><p className=" bg-gray-300 text-black text-decoration:none opacity-80">
        ...
        <li className="mb-2 rounded hover:shadow py-2">
          <a href="" style={{ textDecoration: 'none' }} ><p className=" bg-gray-300 text-black text-decoration:none opacity-80">
            <FaRegFileAlt className="inline-block  bg-gray-300 text-black opacity-70 w-6 h-6 mr-2 mt-2" >
          </FaRegFileAlt >    Feedback from Admin </p>
          </a>
        </li> 
        <li className="mb-2 rounded hover:shadow py-2">
          <a href="" style={{ textDecoration: 'none' }} ><p className=" bg-gray-300 text-black text-decoration:none opacity-80">
